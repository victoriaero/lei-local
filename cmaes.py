...
# ---------------------------
# Evita timeout agressivo em HEAD/metadata quando a rede oscila.
os.environ.setdefault("HF_HUB_ETAG_TIMEOUT", "60")
os.environ.setdefault("HF_HUB_DOWNLOAD_TIMEOUT", "120")

# Se True, tenta carregar SOMENTE do cache local primeiro.
...
# ===========================
CUDA_DEVICE_INDEX = int(os.environ.get("LEI_CUDA_DEVICE", "1"))
DEVICE = torch.device(
